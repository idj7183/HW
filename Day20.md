...
**3번 실행결과**
+ 문자열을 입력해주세요(종료는 -1을 입력해주세요) : a<li>-1
+ 문자열을 입력해주세요(종료는 -1을 입력해주세요) : a		-2
+ 문자열을 입력해주세요(종료는 -1을 입력해주세요) : a		-2
+ 문자열을 입력해주세요(종료는 -1을 입력해주세요) : a		-1		a
+ 문자열을 입력해주세요(종료는 -1을 입력해주세요) : a		-1		2
+ 문자열을 입력해주세요(종료는 -1을 입력해주세요) : -1		-1		-1
+ 문자열을 입력해주세요(종료는 -1을 입력해주세요) : -1
+ a 개수 : 6
+ 공백을 제외한 문자열 : a-1a-2a-2a-1aa-12-1-1-1
